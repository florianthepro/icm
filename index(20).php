...
function run_cycle(string $id, bool $initial = false): array
{
    ...
    try {
        ...
        if ($initial) {
            // Mit MOVE: 1. alles in den Posteingang, 2. leere Ordner loeschen.
            // Tiefste Ebene zuerst, sonst haengt ein Elternordner an seinen Kindern.
            // Ohne MOVE (z. B. iCloud): nichts aus Ordnern holen und nichts
            // loeschen. Ein COPY nach INBOX wuerde nur Kopien erzeugen, ein
            // DELETE auf einen noch vollen Ordner koennte Post kosten. Die
  ...
  <div class="cols">
    ...
    <div>
      <section class="card">
        ...
        <?php if ($st === 'bereit'): ?>
          <div class="hint" style="margin-top:8px">Neu initialisieren sortiert von vorne. Auf
            ...
            Post unangetastet - es wird nichts geloescht.</div>
        <?php endif; ?>
      </section>
    </div>
  </div>
